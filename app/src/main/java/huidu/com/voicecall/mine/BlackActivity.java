...
import huidu.com.voicecall.utils.SlideRecyclerView;
import huidu.com.voicecall.utils.SwipeMenu;
...
public class BlackActivity extends BaseActivity implements RequestFinish {
    ...
    protected void initData() {
        ...
        mAdapter = new BaseQuickAdapter<UserBlack.BlackList,BaseViewHolder>(R.layout.item_black,mList) {
            @Override
            protected void convert(BaseViewHolder helper, final UserBlack.BlackList item) {
